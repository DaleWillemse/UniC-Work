...
namespace UsingDatabases {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PersonRow AddPersonRow(int PersonID, string LastName, string FirstName, string Address, string City) {
...
namespace UsingDatabases.Database1DataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Person] WHERE (([PersonID] = @Original_PersonID) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_City = 1 AND [City] IS NULL) OR ([City] = @Original_City)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Person] ([PersonID], [LastName], [FirstName], [Address], [City" +
                "]) VALUES (@PersonID, @LastName, @FirstName, @Address, @City);\r\nSELECT PersonID," +
                " LastName, FirstName, Address, City FROM Person WHERE (PersonID = @PersonID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Person] SET [PersonID] = @PersonID, [LastName] = @LastName, [FirstName] = @FirstName, [Address] = @Address, [City] = @City WHERE (([PersonID] = @Original_PersonID) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_City = 1 AND [City] IS NULL) OR ([City] = @Original_City)));
SELECT PersonID, LastName, FirstName, Address, City FROM Person WHERE (PersonID = @PersonID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::UsingDatabases.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PersonID, LastName, FirstName, Address, City FROM dbo.Person";
        ...
        public virtual int Delete(int Original_PersonID, string Original_LastName, string Original_FirstName, string Original_Address, string Original_City) {
        ...
        public virtual int Insert(int PersonID, string LastName, string FirstName, string Address, string City) {
        ...
        public virtual int Update(int PersonID, string LastName, string FirstName, string Address, string City, int Original_PersonID, string Original_LastName, string Original_FirstName, string Original_Address, string Original_City) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string LastName, string FirstName, string Address, string City, int Original_PersonID, string Original_LastName, string Original_FirstName, string Original_Address, string Original_City) {
            return this.Update(Original_PersonID, LastName, FirstName, Address, City, Original_PersonID, Original_LastName, Original_FirstName, Original_Address, Original_City);
        }
    }
